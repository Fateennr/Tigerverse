...
export default function Hero() {
  ...
  return (
    <>
      ...
      {/* <div className={`tiger-container ${isLoaded ? "animate-fadeIn" : "opacity-0"}`}>
        <Tiger />
      </div> */}
      ...
      >
        ...
        <div className="flex justify-center space-x-4">
          <button className="px-6 py-3 bg-[#006a4e] text-white rounded-full hover-lift hover:bg-[#005a42] transition-all">
            Explore Team
          </button>
          <button className="px-6 py-3 bg-[#f42a41] text-white rounded-full hover-lift hover:bg-[#d42238] transition-all">
            Match Schedule
          </button>
        </div>
      </div>
